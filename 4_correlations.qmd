...
![Credit: Allison Horst](doc/penguin_bill.jpg){width=50%}
...
penguins %>%
  ...
  select(species, where(is.numeric), -year) %>% # see ?tidyselect::language for selection helpers
